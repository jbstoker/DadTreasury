...
- [Getting Started & Roles](GETTING_STARTED.md) — first run, parent vs child
- [Home Screen](HOME_SCREEN.md) — dashboard, today's tasks, navigation
...
- [Privacy & Offline](PRIVACY.md) — what happens on-device