...
class ProximityAlertReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val CHANNEL_ID_SOUND = "dadstreasury_proximity"
        const val CHANNEL_ID_SILENT = "dadstreasury_proximity_silent"
        const val EXTRA_RULE_ID = "extra_rule_id"
        const val EXTRA_TASK_ID = "extra_task_id"
        const val EXTRA_MESSAGE = "extra_message"
        const val ACTION_MARK_DONE = "com.stokstylez.dadtreasury.ACTION_GEO_DONE"
        const val ACTION_DISABLE = "com.stokstylez.dadtreasury.ACTION_GEO_DISABLE"
